...
!(function ($) {
  ...
  (Carousel.DEFAULTS = {
    ...
    (Carousel.prototype.showHideControl = function (index) {
      void 0 === index && (index = this.getActiveIndex()),
            ...
            this.$element.one("slid", function () {
              var index = that.getActiveIndex(),
                $nextIndicator = $(
                  that.$indicators
                    .children()
                    .slice(index, that.getActiveIndex() + that.options.perView)
                );
              $nextIndicator && $nextIndicator.addClass("vc_active"),
                that.options.partial &&
                  $nextIndicator &&
                  (index + 1 < that.items_count
                    ? $nextIndicator.last().next()
                    : $nextIndicator.first().prev()
                  ).addClass("vc_partial"),
                that.options.wrap || that.showHideControl(index);
            })),
          (this.current_index = $next.index()),
          that.options.wrap || this.showHideControl(this.current_index),
          this.current_index > this.items_count
            ? (this.current_index = 0)
            : this.current_index < 0 &&
              (this.current_index = this.items_count - 1),
          this.options.autoHeight
            ? (this.current_pos_value = -1 * this._step * this.current_index)
            : (this.current_pos_value =
                -1 * $next.position()[this.animation_position]),
    ...
    (Carousel.prototype.recalculateSlidelineHeight = function (
      height,
      animate
    ) {
      !0 === animate
    ...
    (Carousel.prototype.resizeAction = function () {
      var new_slideline_height,
        max_height = 0;
      "horizontal" === this.options.mode &&
        ((this.el_effect_size =
          this.$element.width() *
          (this.options.partial ? this.partial_part : 1)),
        ...
        "vertical" === this.options.mode &&
          ...
          (new_slideline_height =
            this.$active.height() *
            this.options.perView *
            (this.options.partial ? 2 - this.partial_part : 1)),
    ...
    (Carousel.prototype.returnSwipedSlide = function () {
      var params = {};
      (params[this.animation_position] =
        this.current_pos_value + this.pos_units),
    ...
    (Carousel.prototype._build = function () {
      ...
      return (
        ...
        (this.$left_control = this.$element.find(
          ".vc_left.vc_carousel-control"
        )),
        (this.$right_control = this.$element.find(
          ".vc_right.vc_carousel-control"
        )),
        this.options.partial && (this.options.autoHeight = !0),
        1 < this.options.perView &&
          this.$element.addClass(
            "vc_per-view-more vc_per-view-" + this.options.perView
          ),
        "horizontal" === $active_indecators
          ? ((this.pos_units = "%"),
            (this._step = 100 / this.items_count / this.options.perView),
        ...
        this.$indicators.length &&
          (($active_indecators = that.$indicators
            ...
            .slice(
              this.current_index,
              this.current_index + this.options.perView
            )
            .addClass("vc_active")),
          this.options.partial &&
        ...
        el.addEventListener(
          ...
          function (e) {
            (_touch_start_position = parseFloat(e[that.touch_direction])),
              ...
              (_pos_before_touch =
                that.$slideline_inner.position()[that.animation_position]);
          }.bind(this),
          !1
        ),
        el.addEventListener(
          ...
          function (e) {
            return (
              (_diff =
                parseFloat(e[that.touch_direction]) - _touch_start_position),
              !(_moved = 0 < Math.abs(_diff)) ||
                (e.preventDefault(),
                void (that.slideline_inner.style[that.animation_position] =
                  _pos_before_touch + _diff + "px"))
            );
          },
          !1
        ),
        el.addEventListener(
          ...
          function (part) {
            ...
            _moved &&
              ...
              ((velocity = that.velocity(velocity, part)).x >
                that.swipe_velocity &&
                part < 0) ||
              part <= -0.7
  ...
  ($.fn.carousel = function (option, value) {
    return this.each(function () {
      ...
      data ||
        ((data = new Carousel(this, options)), $this.data("vc.carousel", data)),
    ...
    $(document)
      ...
      .on(
        "click.vc.carousel.data-api",
        "[data-slide], [data-slide-to]",
        function (e) {
          var slideIndex = $(this),
            $target = $(
              slideIndex.attr("data-target") ||
                ((options = slideIndex.attr("href")) &&
                  options.replace(/.*(?=#[^\s]+$)/, ""))
            ),
          ...
          slideIndex && (options.interval = !1),
            ...
            slideIndex && $target.data("vc.carousel").to(slideIndex),
            e.preventDefault();
        }
      ),
