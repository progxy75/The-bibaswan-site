            ...
            class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
                ...
                getSwiperSettings() {
                    ...
                    Object.keys(n).reverse().forEach((t => {
                        ...
                        }, e.image_spacing_custom && (a.breakpoints[n[t].value].spaceBetween = this.getSpaceBetween(t)), o = +e["slides_to_show_" + t] || s
                    })), "yes" === e.autoplay && (a.autoplay = {
                        delay: e.autoplay_speed,
                        disableOnInteraction: "yes" === e.pause_on_interaction
                    }), s ? (a.effect = e.effect, "fade" === e.effect && (a.fadeEffect = {
                        crossFade: !0
                    })) : a.slidesPerGroup = +e.slides_to_scroll || 1, e.image_spacing_custom && (a.spaceBetween = this.getSpaceBetween());
                ...
                updateSpaceBetween(e) {
                    ...
                    "desktop" !== s && (this.swiper.params.breakpoints[elementorFrontend.config.responsive.activeBreakpoints[s].value].spaceBetween = n), this.swiper.params.spaceBetween = n, this.swiper.update()
                }
            }
