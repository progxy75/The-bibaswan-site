! function(t) {
    ...
    var s, n, h = t.document,
        ...
        j = function(t) {
            "complete" === h.readyState || "interactive" === h.readyState ? t() : Document && Document.prototype && Document.prototype.addEventListener && Document.prototype.addEventListener !== h.addEventListener ? Document.prototype.addEventListener.call(h, "DOMContentLoaded", t) : h.addEventListener("DOMContentLoaded", t)
        },
        W = function(t, i, s, n) {
    ...
    j((function() {
        ...
        return s.prototype.start = function() {
            ...
            this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), u.MW.N(function() {
        ...
        return t.prototype.onSliderExists = function(t, s, n) {
            ...
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                o.observe(this.sliderElement), this.it = [h.disconnect.bind(h), o.disconnect.bind(o), L(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            } else this.stages.resolve("Visible")
        }, t.prototype._markVisible = function() {
            this.it && z(this.it), this.stages.resolve("Visible")
        ...
        function t(t, s) {
            this.st = t, this.nt = t.sliderElement, this.ht = t.K, this.et = m(this.ht, "alias"), this.ot = f({
                id: 0,
                smoothScroll: 0,
                slideSwitch: 0,
                scroll: 1
            }, s), this.et && (this.ot.smoothScroll && y(o, "scroll-behavior", "smooth"), this.ot.slideSwitch && (this.switchOnLoad(), O(i, "hashchange", function() {
        ...
        function t(i, s, n) {
            this.slider = i, this.responsive = this.slider.responsive, this._type = this.responsive.parameters.type, this._upscale = this.responsive.parameters.upscale, this.at = !1, this.nt = this.slider.sliderElement, this.ut = this.nt.closest(".n2-section-smartslider"), O(h, t.event, this.fullScreenChange.bind(this))
        }
        return t.isSupported = !(!h.exitFullscreen && !h.webkitExitFullscreen), t.isSupported && (t.requestFullscreen = o.requestFullscreen || o.webkitRequestFullscreen, t.exitFullscreen = h.exitFullscreen || h.webkitExitFullscreen, t.event = o.requestFullscreen ? "fullscreenchange" : o.webkitRequestFullscreen ? "webkitfullscreenchange" : null), t.prototype.switchState = function() {
            this.at = !this.at, this.at ? this._fullScreen() : this._normalScreen()
            ...
            this.responsive.at = !0, this.responsive.parameters.type = "fullpage", this.nt.dataset.responsive = this.responsive.parameters.type, this.responsive.parameters.upscale = !0, this._marginLeft = this.responsive.containerElement.style.marginLeft, this._marginRight = this.responsive.containerElement.style.marginRight, g(this.responsive.containerElement, {
                marginLeft: 0,
                marginRight: 0
            }), g(this.ut, {
                width: "100%",
            ...
            this.isDocumentInFullScreenMode() ? (this.slider.G("n2FullScreen"), A(o, "n2-in-fullscreen"), A(this.slider.sliderElement, "n2-ss-slider--fullscreen"), this.at = !0, "auto" === this._type && y(this.slider.responsive.alignElement, "max-width", "none"), F(i, "resize")) : (this.responsive.at = !1, this.responsive.parameters.type = this._type, this.nt.dataset.responsive = this._type, this.responsive.parameters.upscale = this._upscale, g(this.responsive.containerElement, {
                ...
                height: "",
                "background-color": ""
            }), I(this.slider.sliderElement, "n2-ss-slider--fullscreen"), I(o, "n2-in-fullscreen"), "auto" === this._type && k(this.slider.responsive.alignElement, "max-width"), F(i, "resize"), this.at = !1, this.slider.G("n2ExitFullScreen"))
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.ct = 2 === i ? "deltaX" : "deltaY", h.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {
                passive: !1
        ...
        return t.prototype.hasScrollableParentVertical = function(t, s) {
            ...
            !1 !== this.preventScroll.curve && a(this.preventScroll.curveTimeout), this.preventScroll.curveGlobal || (this.dynamicDelta = !1, this.lastDelta = e[this.ct], this.preventScroll.curveGlobal = !0, this.preventScroll.curveGlobalTimeout = r(function() {
        ...
        return t.prototype.onStarterSlide = function() {
            ...
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.at || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && (y(o, "scroll-behavior", "auto"), V(Math.max(0, this.currentInteraction.scrollTop - t)))))
        ...
        var t = new class {
            constructor() {
                this.lt = new Set, this.dt = new Set, this.h = this.u.bind(this)
            }
            add(t) {
                this.lt.add(t)
            }
            invalidate(t) {
                this.dt.add(t), 1 === this.dt.size && u.t.add(this.h)
            }
            u() {
                for (let t of this.dt) t.ft();
                for (let t of this.dt) t.onResizeSize();
                for (let t of this.dt) t.onResizePosition();
                this.dt.clear(), u.t.remove(this.h)
            }
        };
        ...
        return i.prototype = Object.create(u.FrontendPlacement.prototype), i.prototype.constructor = i, i.prototype.start = function() {
            ...
            u.FrontendPlacement.prototype.ft.apply(this, arguments);
            ...
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                ...
                switch (a) {
                    case "right":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.St.slideWidth : this.vt.width, s.xAbs = Math.round(v + o), s.xPAbs = -100;
                        break;
                    case "center":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.St.slideWidth : this.vt.width, s.xAbs = Math.round(v / 2 + o), s.xPAbs = -50;
                        break;
                    default:
                ...
                switch (c) {
                    case "bottom":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.St.slideHeight : this.vt.height, s.yAbs = Math.round(p + r), s.yPAbs = -100;
                        break;
                    case "middle":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.St.slideHeight : this.vt.height, s.yAbs = Math.round(p / 2 + r), s.yPAbs = -50;
                        break;
                    default:
            ...
            this.isVisible() && (this.bt = i, this.St = s, t.invalidate(this), u.FrontendPlacement.prototype.onResize.apply(this, arguments))
        ...
        function l(t, s) {
            for (var n in this.state = {
                    StarterSlide: !1
                }, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.at = !1, this.visibleRealSlidesChanged = !0, this.wt = -1, this.yt = -1, this.gt = -1, this.kt = -1, this.filters = {
                    SliderWidth: [],
                    SliderHeight: [],
                    SlideHeight: [],
                    SliderVerticalCSS: []
            ...
            this.parameters.hideOn = i.ssOverrideHideOn || this.parameters.hideOn, this.doThrottledResize = NextendThrottle(this.doResize.bind(this), 50), this.slider = t, this.sliderElement = t.sliderElement, this.Ct = "1" === m(this.sliderElement, "ssLegacyFontScale"), this.addFilter("SliderWidth", this.filterSliderWidthHorizontalSpacing.bind(this))
        }
        return h.addEventListener("scroll", (function() {
            ...
            this.wt = i.innerWidth, this.yt = i.innerHeight, this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.xt || (this.xt = !0, T(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
            ...
            }, this.Ct && C(this.sliderElement.querySelectorAll('.n2-ss-layer[data-sstype="slide"] > .n2-ss-layer[data-pm="absolute"][data-adaptivefont="0"]'), "font-size", "calc(" + 16 * this.ratios.slideW + "px * var(--ssfont-scale, 1))");
        ...
        return t.prototype.whenLoaded = function() {
            ...
            var t = c("iframe");
            t.className = "intrinsic-ignore", t.allow = "fullscreen; autoplay; encrypted-media", t.id = this.playerId + "-frame", t.src = "https://player.vimeo.com/video/" + this.parameters.vimeocode + "?autoplay=0&_video&title=" + this.parameters.title + "&byline=" + this.parameters.byline + "&background=" + this.parameters.background + "&portrait=" + this.parameters.portrait + "&color=" + this.parameters.color + "&loop=" + this.parameters.loop + ("-1" == this.parameters.quality ? "" : "&quality=" + this.parameters.quality) + "&dnt=" + this.parameters["privacy-enhanced"] + ("" !== this.parameters.privateid ? "&h=" + this.parameters.privateid : ""), t.webkitAllowFullScreen = !0, t.allowFullScreen = !0, g(t, {
                position: "absolute",
                top: 0,
                left: 0,
                width: "100%",
        ...
        function t(t, i, s, n) {
            this.state = {
                ...
                query: [],
                playsinline: 0
            }, s), n2const.isLighthouse || u.r("windowLoad", this.whenLoaded.bind(this))
        }
        var s;
        return t.prototype.whenLoaded = function() {
            ...
            this.layer = t.layer, this.cover && (n2const.isMobile && T(this.cover, "click", this.play.bind(this)), T(t, "n2play", this.fadeOutCover.bind(this))), this.slide = this.slider.findSlideByElement(this.playerElement), this.isStatic = this.slide.isStatic();
            var s = {
                enablejsapi: 1,
