! function(t) {
    ...
    var n, s, r = t.document,
        ...
        x = function(t) {
            "complete" === r.readyState || "interactive" === r.readyState ? t() : Document && Document.prototype && Document.prototype.addEventListener && Document.prototype.addEventListener !== r.addEventListener ? Document.prototype.addEventListener.call(r, "DOMContentLoaded", t) : r.addEventListener("DOMContentLoaded", t)
        },
        ...
        function() {
            ...
            class h {
                    ...
                    for (let i of this.p) {
                        ...
                        switch (i) {
                            ...
                            case "filter":
                                ...
                                break;
                            case "n2AutoAlpha":
                                0 === this.opacity ? this.M || (this.M = !0, this._("data-force-hidden", "")) : this.M && (this.M = !1, this.P("data-force-hidden"));
                                continue;
                            case "opacity":
                                this.v.n2AutoAlpha && (0 === t ? this.M || (this.M = !0, this._("data-force-hidden", "")) : this.M && (this.M = !1, this.P("data-force-hidden")));
                                break;
                            case "width":
                            case "height":
                            case "perspective":
                ...
                m() {
                    ...
                    return O && (S += "perspective(" + O + "px) "), (t || i) && (S += "translate(" + (t || 0) + "%, " + (i || 0) + "%) "), (a || u) && (S += "translate(" + (a || 0) + "px, " + (u || 0) + "px) "), (c || f) && (S += "translate(" + (c || 0) + "%, " + (f || 0) + "%) "), S += n(r, o, h, k), _ && (S += "skewX(" + _ + "deg) "), P && (S += "skewY(" + P + "deg) "), m && (S += "rotate(" + m + "deg) "), g && (S += "rotate(" + g + "deg) "), b && (S += "rotateY(" + b + "deg) "), w && (S += "rotateX(" + w + "deg) "), y === s && (y = 1), M === s && (M = 1), 1 === y && 1 === M || (S += "scale(" + y + ", " + M + ") "), x === s && (x = 1), 1 !== x && (S += "scaleZ(" + x + ") "), S || "translate3d(0, 0, 0)"
                }
                g() {
                    let {
                        n2blur: t
            ...
            class a {
                constructor(t, i) {
                    this.O = [];
                    for (var n = 0; n < t.length; n++) t[n] && this.O.push(b.k(t[n], i))
                }
                setValues(t) {
                    for (var i = 0; i < this.O.length; i++) this.O[i].setValues(t)
                }
            }
            var c = {},
                l = function(t) {
                    Object.defineProperty(a.prototype, t, {
                        ...
                        set: function(i) {
                            ...
                            for (var n = 0; n < this.O.length; n++) this.O[n][t] = i
                        }
                    })
                },
                v = function(t, i, n) {
            ...
            connectedCallback() {
                if (this.isConnected) {
                    n = n || r.body, this.L = "rtl" === o.getAttribute("dir"), this._width = 0, this._offset = Number.MAX_SAFE_INTEGER, this.X = u.MW.k(this, {
            ...
            doResize() {
                ...
                if (this.fullWidthTo) {
                    ...
                    s = r.width, t = this.L ? -s + r.right : r.left
                }
                var o, h, a = s > 0 ? s : n.clientWidth,
                    u = i.getComputedStyle(this.parentNode);
                o = this.L ? a - this.parentNode.getBoundingClientRect().right - parseInt(u.getPropertyValue("padding-right")) - parseInt(u.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(u.getPropertyValue("padding-left")) - parseInt(u.getPropertyValue("border-left-width")) + t, o += h = o % 1, a -= Math.floor(h), (this._width - a <= 0 || this._width - a > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.X.x = o, this._offset = o, 0 !== o && this.classList.add("n2-ss-no-bga-fixed")), this._width !== a && (this.X.width = a, this._width = a)), this.setVisible && this.setVisible()
            }
            setVisible() {
    ...
    var P, O = "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
    i.n2const = {
            devicePixelRatio: i.devicePixelRatio || 1,
            isFirefox: /Firefox/i.test(navigator.userAgent),
            isIOS: /iPad|iPhone|iPod/.test(navigator.platform) || O,
            isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Silk/i.test(navigator.userAgent) || O,
        ...
        }, i.n2const.isTablet = !i.n2const.isPhone && (/Android|iPad|tablet|Silk/i.test(navigator.userAgent) || O), i.n2const.rtl = (i.n2const.isRTL = function() {
            ...
            right: "right",
            modifier: 1
        }), u._triggerResize = (P = null, function() {
            P && a(P), P = h((function() {
                y(i, "resize"), P = null
            }), 100)
            ...
            return function(a, u) {
                ...
                function A(e, t) {
                    if ((e.isPrimary === s || e.isPrimary) && !o && (l = [], x = !0, !O[p = t](e) && !k(e.target)))
                        if (("mousedown" === e.type || "pointerdown" === e.type && "mouse" === e.pointerType) && e.target.closest(".n2-ss-text")) {
                            ...
                            h(i, 2e3)
                        } else o = !0, 0 !== p && l.push(M(r, P[p][1], C, {
                            passive: !1,
                            capture: !0
                        })), l.push(M(r, P[p][2], R, {
                            passive: !1,
                ...
                function C(t) {
                    (t.isPrimary === s || t.isPrimary) && ("x" === c.axis && (!c.preventScroll && v || O[p](t)) || k(t.target) || (E(t), (Math.abs(b.x) > 10 || Math.abs(b.y) > 10) && (x = !1), v === s && 2 !== p && (v = Math.abs(b.x) < Math.abs(b.y) && !c.preventScroll) || c.move(t, g, b, d) && c.preventDefault && S(t)))
                }
                ...
                }))), 1 === _ && (a.style.touchAction = "y" === c.axis ? "pan-x" : "pan-y"), w.push(M(a, P[_][0], (function(e) {
                    A(e, _)
                }), {
                    passive: !1,
                    capture: !0
                })), 0 === _ && w.push(M(a, P[0][1], (function(e) {
                    C(e)
                }), {
                    passive: !1,
                    capture: !0
                })), w.push(M(a, "dragstart", S)), c.mouse && 0 === _ && w.push(M(a, P[2][0], (function(e) {
                    A(e, 2)
