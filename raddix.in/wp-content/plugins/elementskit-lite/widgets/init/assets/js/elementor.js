! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        if (n.hasClass("ekit-template-ajax--yes")) {
            var o = i.find("[data-ajax-post-id]");
            o.hasClass("is--loaded") || e.ajax({
                type: "POST",
                url: ekit_config.ajaxurl,
                data: {
                    action: "ekit_widgetarea_content",
                    nonce: ekit_config.nonce,
                    post_id: o.data("ajax-post-id")
                },
                success: function(n) {
                    o.addClass("is--loaded").html(n), o.find("[data-widget_type]").each((function() {
                        var n = e(this);
        ...
        let n = t.find(".elementskit-submenu-indicator"),
            i = t.find(".megamenu-ajax-load"),
            o = t.closest(".ekit-wid-con").data("responsive-breakpoint");
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.toggleClass("icon icon-down-arrow1 eicon-loading eicon-animation-spin"), e(document).width() <= Number(o) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(o) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(o), n.toggleClass("eicon-loading eicon-animation-spin icon icon-down-arrow1").removeAttr("style"), t.find(".elementor-element").each((function() {
    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === a || i === this) !l && o ? .url && window.open(o.url, r);
                else {
                    ...
                    if (n.hasClass("item-opened")) return void(!l && o ? .url && window.open(o.url, r))
                }
            }))
        },
        Nav_Menu: function(t) {
            if (t.find(".elementskit-megamenu-has").length > 0) {
                let n = t.find(".ekit-wid-con").data("responsive-breakpoint"),
                    ...
                    o = t.find(".elementskit-menu-container").outerHeight();
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    ...
                    let o = e(this).parent(),
                        ...
                        s = o.find(">.elementskit-dropdown, >.elementskit-megamenu-panel");
                    t.find(".elementskit-dropdown-has").not(a).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"), s.toggleClass("ekit-dropdown-open-onclick")
                })), e(window).on("resize", (function() {
        ...
        Progressbar: function(e) {
            ...
            t.elementorWaypoint((function() {
                i.animateNumbers(o, !0, a), n.animate({
                    width: o + "%"
                }, a)
            }), {
                offset: "100%"
        ...
        Funfact: function(e) {
            ...
            t.elementorWaypoint((function() {
                "static" == i ? n.animateNumbers(o, !0, a) : new Odometer({
                    el: n[0],
                    value: 0,
                    duration: a
                }).update(o)
        ...
        Countdown_Timer: function(t) {
            var n = t.find(".ekit-countdown"),
                ...
                s = "elementskit-timer-content ekit-countdown-inner";
            if (n.length) {
                switch (n[0].classList[0]) {
                    case "elementskit-countdown-timer":
                    default:
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + o + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + o + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + o + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + o + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>";
                        break;
                    case "elementskit-countdown-timer-3":
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + s + '"><div class="' + a + '"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + s + '"><div class="' + a + '"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + s + '"><div class="' + a + '"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + s + '"><div class="' + a + '"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>"
                }
            ...
            if (l.length) {
                ...
                let i = l.children(".elementskit-mins"),
                    o = l.children(".elementskit-secs"),
                    a = l.children(".elementskit-hrs"),
                    s = l.children(".elementskit-days"),
                ...
                l.theFinalCountdown(r.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, o), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, a), m(c.d, e.offset.days, s), m(c.w, e.offset.weeks, d), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
        ...
        Testimonial_Slider: function(e) {
            ...
            t.arrows && (t.navigation = {
                ...
                renderCustom: (e, t, n) => {
                    var i = "";
                    for (let e = 1; e <= n; e++) i += '<li class="' + (t === e ? " swiper-pagination-bullet-active slick-active" : "swiper-pagination-bullet") + '"><button type="button" tabindex="0" role="button" aria-label="Go to slide' + e + '" class="">' + e + "</button></li>";
                    return i
                }
            });
            let n = new Swiper(e.find(".swiper-container"), t);
        ...
        PostTab: function(t) {
            ...
            t.on(n, ".tab__list__item", (function() {
                var t = e(this),
                    n = o.eq(t.index());
                i.add(o).removeClass("active"), t.add(n).addClass("active")
            }))
        },
        ...
        Back_To_Top: function(t) {
            ...
            n.on("click", (e => {
                ...
                })(Math.ceil(window.pageYOffset) > o + i)
            }))
        },
        Video: function(t) {
            var n = t.find(".video-content"),
                i = n.find(".ekit-video-popup"),
                o = n.data("video-player"),
...
function(e) {
    ...
    e.fn.animateNumbers = function(t, n, i, o) {
        return this.each((function() {
            var a = e(this),
                s = parseInt(a.text().replace(/,/g, ""), 10);
            n = n === undefined || n, e({
                value: s
            }).animate({
                value: t
        ...
        return this.easyPieChart({
            barColor: !0 === n.gradientChart ? function(e) {
                var t = this.renderer.getCtx(),
                    ...
                    o = t.createLinearGradient(0, 0, i.width, 0);
                return o.addColorStop(0, n.gradientColor1), o.addColorStop(1, n.gradientColor2), o
            } : n.barColor,
