                ...
                window.fluentFormApp = function(t) {
                    ...
                    return s = a, f = {}, c = function() {
                        ...
                        try {
                            ...
                            r(I + "_success").remove(), r(I + "_errors").html(""), e.find(".error").html(""), e.parent().find(".ff-errors-in-stack").hide(),
                                function(e, t) {
                                    var r = [],
                                        n = f;
                        ...
                        if (!this.isSending) {
                            ...
                            this.isSending = !0, r.post(s, n).then((function(n) {
                                ...
                                if (n.data.append_data && F(n.data.append_data), n.data.nextAction) t.trigger("fluentform_next_action_" + n.data.nextAction, {
                                    ...
                                    var s = r(a);
                                    s.length && !k(s[0]) && r("html, body").animate({
                                        scrollTop: s.offset().top - (r("#wpadminbar") ? 32 : 0) - 20
                        ...
                        if (n && "stackToBottom" != n) {
                            ...
                            i.length && !k(i[0]) && r("html, body").delay(e).animate({
                                scrollTop: i.offset().top - (r("#wpadminbar") ? 32 : 0) - 20
                            }, e)
                        }
                    }, k = function(e) {
                        if (!e) return !0;
                        ...
                        if (t.parent().find(".ff-errors-in-stack").empty(), e)
                            if ("string" != typeof e) {
                                var n = o.settings.layout.errorMessagePlacement;
                        ...
                        })), k(t[0]) || r("html, body").animate({
                            scrollTop: t.offset().top - 100
                        }, 350), t.on("click", ".error-clear", (function() {
                        ...
                        var n, i;
                        (n = T(e)).length ? (n.attr("aria-invalid", "true"), (i = r("<div/>", {
                            class: "error text-danger"
                        })).attr("role", "alert"), n.closest(".ff-el-group").addClass("ff-el-is-error"), n.closest(".ff-el-input--content").find("div.error").remove(), n.closest(".ff-el-input--content").append(i.text(t))) : j([t])
                    }, O = function() {
                        ...
                        reinitExtras: function() {
                            if (t.find(".ff-el-recaptcha.g-recaptcha").length) {
                                var e = (n = t.find(".ff-el-recaptcha.g-recaptcha")).data("sitekey"),
                                    r = n.attr("id");
                                grecaptcha.render(document.getElementById(r), {
                                    sitekey: e
                                })
                            }
                            var n;
                            t.find(".ff-el-turnstile.cf-turnstile").length && (e = (n = t.find(".ff-el-turnstile.cf-turnstile")).data("sitekey"), r = n.attr("id"), console.log(r), turnstile.render(document.getElementById(r), {
                                sitekey: e
                            }))
                        },
                        initTriggers: function() {
                            t = c(), jQuery(document.body).trigger("fluentform_init", [t, o]), jQuery(document.body).trigger("fluentform_init_" + o.id, [t, o]), t.trigger("fluentform_init_single", [this, o]), t.find("input.ff-el-form-control").on("keypress", (function(e) {
                                ...
                                var n = r(this).data("content"),
                                    i = r(".ff-el-pop-content");
                                i.length || (r("<div/>", {
                                    class: "ff-el-pop-content"
                                }).appendTo(document.body), i = r(".ff-el-pop-content")), i.html(n);
                        ...
                        initMultiSelect: function() {
                            r.isFunction(window.Choices) && r(".ff_has_multi_select").length && r(".ff_has_multi_select").each((function(e, n) {
                                var i = t(t({}, {
                                    ...
                                    a = r(n).attr("data-max_selected_options");
