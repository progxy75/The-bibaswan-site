! function i(n, r, s) {
    ...
    1: [function(e, t, o) {
        ...
        o.slideToggle = function(e, t) {
            ("none" === window.getComputedStyle(e).display ? r : s)(e, t)
        };
        ...
        o.isElement = function(e) {
            return "object" === ("undefined" == typeof HTMLElement ? "undefined" : (0, n.default)(HTMLElement)) ? e instanceof HTMLElement : e && "object" === (0, n.default)(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName
        };
        var c, e = (c = document.createDocumentFragment(), function(e) {
            try {
                c.querySelector(e)
            } catch (e) {
                return !1
    ...
    2: [function(e, t, o) {
        "use strict";
        var i = e("@babel/runtime/helpers/interopRequireDefault"),
            n = i(e("@babel/runtime/helpers/defineProperty")),
            r = i(e("@babel/runtime/helpers/classCallCheck")),
            s = i(e("@babel/runtime/helpers/classPrivateFieldSet")),
            l = i(e("@babel/runtime/helpers/classPrivateFieldGet")),
            a = e("../lib/utils");
        ...
        var p = new WeakMap,
            ...
            e = function e() {
                ...
                (0, r.default)(this, e), p.set(this, {
                    ...
                    writable: !0,
                    value: function() {
                        (0, s.default)(n, p, u(u({}, (0, l.default)(n, p)), {}, {
                    ...
                    value: function() {
                        document.querySelectorAll('a[href*="#"]:not([href="#"]):not(.comment-navigation .nav-links a), a.local[href*="#"]:not([href="#"]), .local a[href*="#"]:not([href="#"]), a.menu-link[href*="#"]:not([href="#"]), a.sidr-class-menu-link[href*="#"]:not([href="#"])').forEach(function(e) {
                            e.addEventListener("click", (0, l.default)(n, y))
                        })
                    }
                }), y.set(this, {
                    writable: !0,
                    ...
                    writable: !0,
                    value: function() {
                        return (0, l.default)(n, p).WPAdminbar ? (0, l.default)(n, p).WPAdminbar.offsetHeight : 0
                    }
                }), b.set(this, {
                    writable: !0,
                    value: function() {
                        return (0, l.default)(n, p).topbarWrapper && (0, l.default)(n, p).topbarWrapper.classList.contains("top-bar-sticky") ? (0, l.default)(n, p).topbarWrapper.offsetHeight : 0
                    }
                }), m.set(this, {
                    writable: !0,
                    value: function() {
                        ...
                        if (o) {
                            if (o.classList.contains("is-sticky") && !t) return (0, l.default)(n, p).header.offsetHeight;
                            if (null !== (t = (0, l.default)(n, p).header) && void 0 !== t && t.classList.contains("top-header")) return Number.parseInt(getComputedStyle(o).height);
                            if (null !== (o = (0, l.default)(n, p).header) && void 0 !== o && o.classList.contains("medium-header")) {
                                var i = (0, l.default)(n, p).header.querySelector(".bottom-header-wrap");
                                return i.classList.contains("fixed-scroll") ? i.offsetHeight : (0, l.default)(n, p).header.classList.contains("hidden-menu") ? (0, l.default)(n, p).header.dataset.height : (0, l.default)(n, p).header.offsetHeight
                            }
                            return null !== (i = (0, l.default)(n, p).header) && void 0 !== i && i.classList.contains("fixed-header") ? (0, l.default)(n, p).header.offsetHeight : null !== (i = (0, l.default)(n, p).header) && void 0 !== i && i.classList.contains("up-effect") ? 0 : null !== (e = null === (e = (0, l.default)(n, p).header) || void 0 === e ? void 0 : e.dataset.height) && void 0 !== e ? e : 54
                        }
                ...
                }), (0, l.default)(this, p).body.classList.contains("single-product") || (0, l.default)(this, p).body.classList.contains("no-local-scroll") || ((0, l.default)(this, d).call(this), (0, l.default)(this, f).call(this))
            };
        window.oceanwp = window.oceanwp || {}, oceanwp.scrollEffect = new e
    }, {
        "../lib/utils": 1,
