    ...
    $(function() {
        ...
        $(window).scroll(function() {
            if ($(window).scrollTop() >= 77) {
                $('.btmheadnav').addClass('fixed-header');
                $('.btmlogo').addClass('visible-title');
            } else {
                $('.btmheadnav').removeClass('fixed-header');
                $('.btmlogo').removeClass('visible-title');
            }
        });
        //fixed header

        // fixed navabar js ends
